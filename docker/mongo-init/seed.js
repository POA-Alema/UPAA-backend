    ...
    institutions: [
      {
        ...
        description: {
          pt: 'Espaco de documentacao e memoria cultural da PUCRS',
          en: 'PUCRS documentation and cultural memory center',
          de: 'Dokumentations- und Kulturgedachtniszentrum der PUCRS',
        },
        CTA: {
          label: {
            pt: 'Acessar',
          ...
          target: 'https://www.pucrs.br/delfos/',
          icon: 'external-link',
        },
        imageURL: '',
        order: 1,
      },
      {
        ...
        description: {
          pt: 'Agencia experimental da Escola Politecnica da PUCRS',
          en: 'Experimental agency of the PUCRS Polytechnic School',
          de: 'Experimentelle Agentur der Polytechnischen Schule der PUCRS',
        },
        CTA: {
          label: {
            pt: 'Acessar',
